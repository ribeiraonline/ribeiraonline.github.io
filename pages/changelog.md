...
meta_title: "RibeiraOnline Theme Changelog"
subheadline: "RibeiraOnline Theme Changelog"
teaser: "History and changelog of RibeiraOnline Theme"
header:
...
:   OK. Let's try it. Here is *RibeiraOnline* Version 1.0, with a shiny video.
...
:   Yes! Now *RibeiraOnline* uses the built-in sass-support by Jekyll. Open `_sass` and dig deeper into customizing this theme using your colors, typography and so on...
...
:   Moved images folder from `assets/img/` to `images` to fasten access to folder. Moved all pages to `pages/`-folder for better organization. Added language-functionality. *RibeiraOnline* is now translation ready.
...
:   Better typograpyh, extended [documentation]({{ site.url }}/documentation/) and little subtle css-things to make *RibeiraOnline* a little better.

2014-08-17 // Version 0.4
:   First beta release of »RibeiraOnline« with the current jekyll templates.

2014-08-17 // Version 0.3
:   First release – only *HTML-Version* – of »RibeiraOnline« on Github-Pages with some hickups.
